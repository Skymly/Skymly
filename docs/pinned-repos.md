...
| 6 | [`MvvmAIO/Prism.SourceGenerators`](https://github.com/MvvmAIO/Prism.SourceGenerators) | Prism MVVM source generators (collaboration) |

**If you need a slot for `MvvmAIO/MvvmAIO.R3.SourceGenerators`** — Drop `Observables.Samples` or `Observables.Docs`, or swap pin 6 for [`MvvmAIO/MvvmAIO.R3.SourceGenerators`](https://github.com/MvvmAIO/MvvmAIO.R3.SourceGenerators).

**Optional** — Pin [`Skymly/Skymly`](https://github.com/Skymly/Skymly) (this profile README) instead of one MvvmAIO repo.
